...
## Optimizer
optimizer_ttime = ScheduledOptim(torch.optim.Adam(TTime_combine.parameters(), betas=(0.9, 0.98), eps=1e-9, amsgrad=False), args.lr, dim_embedding, args.n_warmup_steps)
